...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#mainContainer {\n    margin-top: 30px;\n}\n\n#gameStartArea {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    visibility: hidden;\n}\n\n#labels {\n    display: grid;\n    grid-template-columns: 1fr 2fr 2fr 1fr;\n}\n\n#pLabel {\n    grid-column: 2;\n}\n\n#cLabel {\n    visibility: hidden;\n    grid-column: 3;\n}\n\n#playerB {\n    grid-column: 2;\n}\n\n#aiB {\n    grid-column: 3;\n}\n\n#playerControl {\n    grid-column: 3;\n    display: flex;\n    align-items: flex-start;\n    flex-direction: column-reverse;\n    justify-content: center;\n}\n\n#gameInfo {\n    grid-column: 1;\n    display: flex;\n    justify-content: flex-start;\n    align-items: center;\n    padding: 5px;\n}\n\n#playerB, #aiB {\n    display: grid;\n    align-items: center;\n    grid-template-columns: repeat(10, 1fr);\n    grid-template-rows: repeat(10, 1fr);\n    max-width: 400px;\n}\n\n.boardLayout > div {\n    border: 1px solid black;\n    padding: 5px;\n    background-color:rgb(68, 182, 216);\n    min-height: 50px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n\n#aiB {\n    visibility: hidden;\n}\n\n@media (min-width: 1201px){\n    #boardC {\n        display: grid;\n        grid-template-columns: 1fr 2fr 2fr 1fr;\n    }\n\n}\n\n@media (max-width: 1200px){\n    #playerB {\n        margin-bottom: 20px;\n    }\n\n}\n\n#winnerCircle {\n    margin-top: 20px;\n    text-align: center;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,sCAAsC;AAC1C;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,kBAAkB;IAClB,cAAc;AAClB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,cAAc;IACd,aAAa;IACb,uBAAuB;IACvB,8BAA8B;IAC9B,uBAAuB;AAC3B;;AAEA;IACI,cAAc;IACd,aAAa;IACb,2BAA2B;IAC3B,mBAAmB;IACnB,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,sCAAsC;IACtC,mCAAmC;IACnC,gBAAgB;AACpB;;AAEA;IACI,uBAAuB;IACvB,YAAY;IACZ,kCAAkC;IAClC,gBAAgB;IAChB,aAAa;IACb,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI;QACI,aAAa;QACb,sCAAsC;IAC1C;;AAEJ;;AAEA;IACI;QACI,mBAAmB;IACvB;;AAEJ;;AAEA;IACI,gBAAgB;IAChB,kBAAkB;AACtB","sourcesContent":["#mainContainer {\n    margin-top: 30px;\n}\n\n#gameStartArea {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    visibility: hidden;\n}\n\n#labels {\n    display: grid;\n    grid-template-columns: 1fr 2fr 2fr 1fr;\n}\n\n#pLabel {\n    grid-column: 2;\n}\n\n#cLabel {\n    visibility: hidden;\n    grid-column: 3;\n}\n\n#playerB {\n    grid-column: 2;\n}\n\n#aiB {\n    grid-column: 3;\n}\n\n#playerControl {\n    grid-column: 3;\n    display: flex;\n    align-items: flex-start;\n    flex-direction: column-reverse;\n    justify-content: center;\n}\n\n#gameInfo {\n    grid-column: 1;\n    display: flex;\n    justify-content: flex-start;\n    align-items: center;\n    padding: 5px;\n}\n\n#playerB, #aiB {\n    display: grid;\n    align-items: center;\n    grid-template-columns: repeat(10, 1fr);\n    grid-template-rows: repeat(10, 1fr);\n    max-width: 400px;\n}\n\n.boardLayout > div {\n    border: 1px solid black;\n    padding: 5px;\n    background-color:rgb(68, 182, 216);\n    min-height: 50px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n\n#aiB {\n    visibility: hidden;\n}\n\n@media (min-width: 1201px){\n    #boardC {\n        display: grid;\n        grid-template-columns: 1fr 2fr 2fr 1fr;\n    }\n\n}\n\n@media (max-width: 1200px){\n    #playerB {\n        margin-bottom: 20px;\n    }\n\n}\n\n#winnerCircle {\n    margin-top: 20px;\n    text-align: center;\n}"],"sourceRoot":""}]);
// Exports
